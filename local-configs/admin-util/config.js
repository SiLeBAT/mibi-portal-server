...
var mongo = {
  ...
  connectionString: 'mongodb://localhost:27017/epilab',
  db: 'epilab',
  username: 'mibiUserManager',
...
module.exports = {
  ...
  site: {
    ...
    baseUrl: process.env.ME_CONFIG_SITE_BASEURL || '/admin',
    cookieKeyName: 'mongo-express',
    cookieSecret:     process.env.ME_CONFIG_SITE_COOKIESECRET   || 'localcookiesecret',
    host:             process.env.VCAP_APP_HOST                 || 'localhost',
    port:             process.env.VCAP_APP_PORT                 || 3001,
    requestSizeLimit: process.env.ME_CONFIG_REQUEST_SIZE        || '50mb',
    sessionSecret:    process.env.ME_CONFIG_SITE_SESSIONSECRET  || 'localsessionsecret',
