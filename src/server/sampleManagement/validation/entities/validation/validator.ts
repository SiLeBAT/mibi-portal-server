...
class SampleValidator implements IValidator {
    ...
    constructor(config: IValidatorConfig) {
        ...
        this.catalogProvider = config.catalogProvider;
        this.pathogenIndex = createPathogenIndex(this.catalogProvider('adv16').dump());
    ...
    private registerCustomValidators() {
        ...
        validate.validators.inCatalog = inCatalog(this.catalogProvider);
        validate.validators.registeredZoMo = registeredZoMo(this.catalogProvider);
        validate.validators.nonUniqueEntry = nonUniqueEntry(this.catalogProvider);
