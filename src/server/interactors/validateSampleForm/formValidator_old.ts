...
export class FormValidator {
    ...
    public validateSamples(samples: ISample[]): ISample[] {
        ...
        const checkedForDuplicateIds = this.checkForDuplicateId(results, 'id_pathogen');
        const allChecked = this.checkForDuplicateId(checkedForDuplicateIds, 'id_avv_pathogen');
