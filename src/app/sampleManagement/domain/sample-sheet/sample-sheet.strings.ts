...
export const sampleSheetSamplesStrings = {
    titles: {
        ...
        sampling_reason_avv: 'Untersu-chungs-grund',
        program_reason_text: 'Kontroll-programm / Untersu-chungs-grund',
        operations_mode_avv: 'Betriebsart',
        operations_mode_text: 'Betriebsart',
        vvvo: 'VVVO-Nr / Herde',
        program_avv: 'Programm',
        comment: 'Bemerkung'
    },
    subtitles: {
        sample_id: '',
        ...
        vvvo: '',
        program_avv: '(Code aus AVV DatA-Kat-Nr. 328)',
        comment: ''
    }
};
