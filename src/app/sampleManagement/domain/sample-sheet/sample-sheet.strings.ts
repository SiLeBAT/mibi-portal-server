...
export const sampleSheetSamplesStrings = {
    titles: {
        ...
        partial_sample_id: 'AVV-DatA-Teil-Proben-Nr.',
        ...
        animal_avv: 'Tiere Code',
        matrix_avv: 'Matrix Code',
        animal_matrix_text: 'Tiere/Matrix',
        primary_production_avv: 'Angaben zur Primär-produktion',
        control_program_avv: 'Kontroll-programm',
        sampling_reason_avv: 'Untersuchungs-grund',
        program_reason_text: 'Kontrollprogramm/ Untersuchungsgrund',
        operations_mode_avv: 'Betriebsart',
