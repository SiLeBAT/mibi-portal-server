export { createController as createLoginController, ILoginController } from './login.controller';
export { createController as createInstitutionController, IInstitutionController } from './institution.controller';
